...
var rootCmd = &cobra.Command{
	Use:   "chaosctl",
	Short: "ChaosCTL controls the Harness Chaos Engineering Cloud chaos delegate plane",
	Long:  `ChaosCTL controls the Harness Chaos Engineering Cloud chaos delegate plane. ` + "\n" + ` Find more information at: https://github.com/chaosnative/chaosctl`,
}
